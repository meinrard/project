...
if (isset($_POST['create'])) {
    ...
    $query = "INSERT INTO exams
              (exam_name, course, course_code, exam_date, start_time, end_time)
              VALUES
              (?, ?, ?, ?, ?, ?)";
    $stmt = mysqli_prepare($conn, $query);
    mysqli_stmt_bind_param($stmt, "ssssss", $exam_name, $course, $course_code, $exam_date, $start_time, $end_time);
    ...
    if (mysqli_stmt_execute($stmt)) {
        ...
        echo "<script>
        alert('Error Creating Exam: " . addslashes(mysqli_error($conn)) . "');
        </script>";
    }
}
?>
...
<div class="content">
    <div class="page-layout">
        <div class="container">
            ...
            <form method="POST">
                <input type="text" name="exam_name" placeholder="Exam (database system)" required>
                <input type="text" name="course" placeholder="Program (computer science & software engineering (RCS342))" required>
                <input type="text" name="course_code" placeholder="Course Code (Example: CSC101)" required>
