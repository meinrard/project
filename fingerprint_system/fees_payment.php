...
// Course total fee
$total_fee = 1800000; // BSc Computer Science
...
if (isset($_POST['pay'])) {
    ...
    if (mysqli_num_rows($check) > 0) {
        ...
        if ($semester == 1) {
            ...
            $required = $total_fee / 2; // Half fee

        } else {

            $required = $total_fee; // Full fee
        ...
        if ($insert) {
            ...
            echo "<script>
            alert('Payment Recorded. Status: $status');
            </script>";
